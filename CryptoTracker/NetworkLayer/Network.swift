...
final class Network: NetworkProtocol {
    ...
    func getCrypto(completion: @escaping (Result<[CryptoModel]?, Error>) -> Void) {
        ...
        networkQueue.async(group: networkTaskGroup)  {
            URLSession.shared.dataTask(with: urlBTC) { data, response, error in
        ...
        networkQueue.async(group: networkTaskGroup)  {
            URLSession.shared.dataTask(with: urlETH) { data, response, error in
                guard let data = data else { return }
                if let error = error {
                    completion(.failure(error))
                }
        ...
        networkQueue.async(group: networkTaskGroup)  {
            URLSession.shared.dataTask(with: urlXRP) { data, response, error in
                guard let data = data else { return }
                if let error = error {
                    completion(.failure(error))
                }
        ...
        networkQueue.async(group: networkTaskGroup)  {
            URLSession.shared.dataTask(with: urlLUNA) { data, response, error in
                guard let data = data else { return }
                if let error = error {
                    completion(.failure(error))
                }
        ...
        networkQueue.async(group: networkTaskGroup)  {
            URLSession.shared.dataTask(with: urlTRON) { data, response, error in
                guard let data = data else { return }
                if let error = error {
                    completion(.failure(error))
                }
        ...
        networkQueue.async(group: networkTaskGroup)  {
            URLSession.shared.dataTask(with: urlTETHER) { data, response, error in
                guard let data = data else { return }
                if let error = error {
                    completion(.failure(error))
                }
        ...
        networkQueue.async(group: networkTaskGroup)  {
            URLSession.shared.dataTask(with: urlCARDANO) { data, response, error in
                guard let data = data else { return }
                if let error = error {
                    completion(.failure(error))
                }
        ...
        networkQueue.async(group: networkTaskGroup)  {
            URLSession.shared.dataTask(with: urlSTELLAR) { data, response, error in
                guard let data = data else { return }
                if let error = error {
                    completion(.failure(error))
                }
        ...
        networkQueue.async(group: networkTaskGroup)  {
            URLSession.shared.dataTask(with: urlDOGECOIN) { data, response, error in
                guard let data = data else { return }
                if let error = error {
                    completion(.failure(error))
                }
        ...
        networkQueue.async(group: networkTaskGroup)  {
            URLSession.shared.dataTask(with: urlPOLKADOT) { data, response, error in
                guard let data = data else { return }
                if let error = error {
                    completion(.failure(error))
                }
